...
\begin{figure}[htbp]
\centering
\includegraphics[width=\textwidth]{fig01_study_area.pdf}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.95\textwidth]{fig02_sar_water_detection.pdf}
...
\caption{JRC Global Surface Water occurrence for Antioquia, used for SAR validation and as an input feature.}
\label{fig:jrc_occurrence}
\end{figure}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{fig05_hand_susceptibility.pdf}
\caption{HAND (Height Above Nearest Drainage) map for Antioquia derived from MERIT Hydro. Low HAND values (red) indicate proximity to the fluvial network and high flood susceptibility.}
\label{fig:hand_map}
\end{figure}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.55\textwidth]{fig06_roc_curves.pdf}
\caption{ROC curves for individual models and the weighted ensemble under spatial cross-validation.}
\label{fig:roc}
\end{figure}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.65\textwidth]{fig07_shap_importance.pdf}
\caption{Global SHAP feature importance for the ensemble model (top 12 of 18 predictors shown). Top three predictors (red) collectively account for 62\% of the total SHAP budget; the six omitted features contribute $<$3\% combined.}
\label{fig:shap}
\end{figure}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{fig08_flood_susceptibility.pdf}
...
\begin{table}[htbp]
\caption{Area distribution across susceptibility classes by subregion (\% of subregional area).}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.85\textwidth]{fig09_municipal_risk_ranking.pdf}
\caption{Top 20 municipalities ranked by Flood Risk Index (FRI). Bar colour indicates subregion; error bars show sensitivity to the exposure threshold $\tau \in [0.5, 0.7]$.}
\label{fig:municipal_ranking}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.75\textwidth]{fig10_population_exposure.pdf}
\caption{Municipal-level population exposure to high and very high flood susceptibility zones ($\tau = 0.6$). Circle size is proportional to exposed population; colour indicates the proportion of total municipal population exposed.}
\label{fig:pop_exposure}
\end{figure}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=\textwidth]{fig11_seasonal_dynamics.pdf}
